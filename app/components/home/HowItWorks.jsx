  ...
  return (
    <section className="py-12 md:py-20 bg-gray-50 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-10 gap-6 md:gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {steps.map((step, i) => (
                <div key={i} className="group relative bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
